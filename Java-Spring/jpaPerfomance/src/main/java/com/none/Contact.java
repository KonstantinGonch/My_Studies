...
@NamedQuery(name="Contact.findById", query = "select distinct c from Contact c left join " +
        "fetch c.contactTelDetails t left join fetch c.hobbies h where c.id=:id"),
